...
//    }
    ...
    private HttpChunk convertToHttpChunk(MLTaskResponse response) throws IOException {
        ...
        try {
            ...
            if (output != null && !output.getMlModelOutputs().isEmpty()) {
                ...
                for (ModelTensor tensor : tensors) {
                    ...
                    } else if ("llm_response".equals(name) && tensor.getDataAsMap() != null) {
        ...
        log.info("Converting to HttpChunk - memoryId: '{}', parentId: '{}', content: '{}', isLast: {}",
                memoryId, parentInteractionId, content, isLast);

        // Create ordered tensors
        List<ModelTensor> orderedTensors = List.of(
                ModelTensor.builder()
                        .name("memory_id")
                        .result(memoryId)
                        .build(),
                ...
                ModelTensor.builder()
                        .name("response")
                        .dataAsMap(new LinkedHashMap<String, Object>() {{
        ...
        ModelTensors tensors = ModelTensors.builder()
                .mlModelTensors(orderedTensors)
                .build();

        ModelTensorOutput tensorOutput = ModelTensorOutput.builder()
                .mlModelOutputs(List.of(tensors))
                .build();
