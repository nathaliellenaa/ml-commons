...
public class TransportPredictionStreamingTaskAction extends HandledTransportAction<ActionRequest, MLTaskResponse> {
    ...
    public class StreamPredictActionListener<Response extends TransportResponse, Request extends TransportRequest>
        ...
        public StreamPredictActionListener(ActionListener<Response> listener, String actionName, Request request) {
    ...
    @Inject
    public TransportPredictionStreamingTaskAction(
        TransportService transportService,
        ...
        super(MLPredictionStreamingTaskAction.NAME, transportService, actionFilters, MLPredictionTaskRequest::new);
    ...
    protected void doExecute(Task task, ActionRequest request, ActionListener<MLTaskResponse> listener, TransportChannel channel) {
        ...
        // }
        log.info("StreamRequest in new class is {}", isStreamingRequest);
                                    ...
                                    if (modelCacheHelper.getIsModelEnabled(modelId) != null
                                        ...
                                        if (FunctionName.isDLModel(functionName)) {
                                            ...
                                            if (isStreamingRequest) {
                                                ...
                                                executeStreamingPredict(mlPredictionTaskRequest, wrappedListener, modelId, channel);
                                                return;
                                            }
                                            validateInputSchema(modelId, mlPredictionTaskRequest.getMlInput());
                                            executePredict(mlPredictionTaskRequest, wrappedListener, modelId);
