...
public class StreamingWrapper {
    ...
    public void sendCompletionChunk(String sessionId, String parentInteractionId, String executorMemoryId, String executorParentInteractionId) {
        if (!isStreaming) {
            return;
        }
        MLTaskResponse completionChunk = createStreamChunk("", sessionId, parentInteractionId, executorMemoryId, executorParentInteractionId,true);
        try {
    ...
    public void sendToolResponse(String toolOutput, String sessionId, String parentInteractionId) {
        if (isStreaming) {
            try {
                // TODO: check if we need to send tool response for PER agent
    ...
    private MLTaskResponse createStreamChunk(String toolOutput, String sessionId, String parentInteractionId, String executorMemoryId, String executorParentInteractionId, boolean isLast) {
